...
module SimpleLayout {
    ...
    /**
     * Provides a set of Layout classes to be used in by a {{#crossLink "LayoutContainer"}}{{/crossLink}}
     *
     * @module SimpleLayout
     * @submodule layout
     */
    export module layout {
        export class BasicLayout implements ILayout{
            ...
            /**
             * The {{#crossLink "BasicLayout"}}{{/crossLink}} is the most basic layout type. use this layout to grant
             * the LayoutItems all the space the can take. The LayoutItems will be on top of each other.
             *
             * @class BasicLayout
             **/
            constructor() {
